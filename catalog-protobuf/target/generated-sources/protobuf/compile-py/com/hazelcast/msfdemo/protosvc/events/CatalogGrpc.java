package com.hazelcast.msfdemo.protosvc.events;
...
public final class CatalogGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest,
      com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse> getPriceLookupMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PriceLookup",
      requestType = com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest.class,
      responseType = com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest,
      com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse> getPriceLookupMethod() {
    io.grpc.MethodDescriptor<com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest, com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse> getPriceLookupMethod;
      ...
      synchronized (CatalogGrpc.class) {
        if ((getPriceLookupMethod = CatalogGrpc.getPriceLookupMethod) == null) {
          CatalogGrpc.getPriceLookupMethod = getPriceLookupMethod =
              io.grpc.MethodDescriptor.<com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest, com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PriceLookup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse.getDefaultInstance()))
  ...
  public static abstract class CatalogImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void priceLookup(com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest request,
        io.grpc.stub.StreamObserver<com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest,
                com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse>(
  ...
  public static final class CatalogBlockingStub extends io.grpc.stub.AbstractBlockingStub<CatalogBlockingStub> {
    ...
    /**
     */
    public com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse priceLookup(com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest request) {
  ...
  public static final class CatalogFutureStub extends io.grpc.stub.AbstractFutureStub<CatalogFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse> priceLookup(
        com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PRICE_LOOKUP:
          serviceImpl.priceLookup((com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupRequest) request,
              (io.grpc.stub.StreamObserver<com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.PriceLookupResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CatalogBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hazelcast.msfdemo.protosvc.events.CatalogOuterClass.getDescriptor();
    }
